                        ...
                        <div className='case-page_image remit-video_cover'></div>
                         ...
                         <div className='case-page__block'>
                            ...
                            <div className='case-page__text case-page__task'>
                                ...
                                <p className='case-page__subtitle'>
                                Необходимо показать все призы, которые можно получить, участвуя в акции. Кроме того, нужно показать настроение расслабленного лета, в этом помогут материалы с фотосессии.
                                </p>
                                <p className='case-page__subtitle'>
