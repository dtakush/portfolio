                ...
                <div className='case-page_section'>
                        ...
                        <div className='case-page__block'>
                           <div className='case-page__text case-page__solution'>
                                ...
                                <p className='case-page__subtitle'>
                                Выбор пал на известнейших творцов – Василий Кандинский, Мауриц Корнелиус Эшер и Энди Уорхол. Каждый из них создал свой собственный  уникальный стиль работ, а значит, он будет узнаваем.
                                </p>
                            </div>
